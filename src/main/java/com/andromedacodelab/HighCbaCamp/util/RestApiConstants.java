...
public class RestApiConstants {
    ...
    public static final String DATES_ARE_INVALID_MESSAGE = "The chosen dates are not valid";
    public static final String DATE_RANGE_NOT_AVAILABLE_MESSAGE = "The chosen date range is already taken, please choose other";
    ...
    public static final String DATE_RANGE_NOT_ACCEPTED_MESSAGE = "The chosen date range exceeds the reservation constraint";
